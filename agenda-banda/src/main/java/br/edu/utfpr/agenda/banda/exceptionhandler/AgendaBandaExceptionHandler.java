package br.edu.utfpr.agenda.banda.exceptionhandler;
...
@ControllerAdvice
public class AgendaBandaExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    public ResponseEntity<Object> handleDataIntegretyViolationException(DataIntegrityViolationException ex, WebRequest request){
