...
insert into tb_agenda_de_shows(id_agenda_de_shows, `data`, `cache`, codigo_casa_de_show, codigo_banda) values (1, str_to_date('04-25-2022','%m-%d-%Y'), 250, 1, 1);
insert into tb_agenda_de_shows(id_agenda_de_shows, `data`, `cache`, codigo_casa_de_show, codigo_banda) values (2, str_to_date('03-17-2022','%m-%d-%Y'), 500, 2, 3);